...
function Stats() {
  ...
  return (  
    <section className="px-4 bg-gray-200">
      ...
      <h2 className="mb-4 md:mb-6 text-3xl md:text-4xl text-center font-semibold">Stats</h2>

        <ul className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 lg:gap-12">
          {statsArr.map((stat) => (
