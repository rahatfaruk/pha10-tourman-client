...
function Country({ country }) {
  ...
  return (
    <div className="relative border shadow-sm rounded-xl">
      ...
      <Link to={`/country-spots/${countryName}`} className="absolute top-0 bottom-0 start-0 end-0 flex flex-col justify-center items-center py-4 px-6 text-center text-white bg-[rgba(0,0,0,.55)] rounded-xl hover:cursor-pointer">
